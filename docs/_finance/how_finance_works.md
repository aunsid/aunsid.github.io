...
`EBITDA` -  earnings before interest, taxes, depriciation, and amortization - is a measure of the cash generated by operations.

The reason to emphasize on DA is beacuse they are expenses that are not associated with the outlay of cash, it is just an approximation of the loss of calue of an asset. Suppose you build a factory. In accounting, you have to depreciate it and charge yourself an expense for that depriciation. But in finance, we emphasize cash and there was no cash outlay.
